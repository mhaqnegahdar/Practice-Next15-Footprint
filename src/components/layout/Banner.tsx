    ...
    <div className="banner flex h-[50vh] w-full p-4 py-6 sm:p-6 lg:h-[60vh] lg:p-8">
      ...
      <div className="relative z-10 rounded-xl bg-cover md:aspect-[2.4/1]">
        <div className="flex h-full w-full flex-col items-center justify-center gap-y-8 text-center">
          <h1 className="banner__text text-center dark:text-foreground">{title}</h1>
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 -z-10 h-full w-full bg-white dark:bg-background bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#4a4a4a_1px,transparent_1px),linear-gradient(to_bottom,#4a4a4a_1px,transparent_1px)] bg-[size:6rem_4rem]"></div>
      </div>
    </div>
  );
};
